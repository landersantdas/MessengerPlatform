...
var FBMessenger = function () {
  ...
  _createClass(FBMessenger, [{
    key: 'sendAction',
    value: function sendAction(id, action) {
    ...
    key: 'sendListMessage',
    value: function sendListMessage(id, elements, buttons, topElementStyle, notificationType, cb) {
      buttons = buttons || [];
    ...
    value: function sendMessage(id, data) {
      var notificationType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.notificationType;
      var cb = arguments[3];
    ...
    key: 'setDomainWhitelist',
    value: function setDomainWhitelist(pageId, domains, cb) {
      var jsonObject = {
